...
Codex Assistant 0.12.0 的公开官网源码。站点介绍 16 套一键主题、本机环境检测、只读子代理观察、安全边界和本机图片导入，并为 x64/ARM64 提供 EXE/MSI 四种 GitHub Release 下载入口。
...
0.12.0 安装包尚未代码签名，官网必须持续显示 SmartScreen/“未知发布者”提示与 SHA-256。
